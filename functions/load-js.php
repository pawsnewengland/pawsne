...
function load_theme_js() {
	...
	wp_register_script('feature-test', get_template_directory_uri() . '/js/feature-test.min.11172013.js', false, null, false);
	wp_enqueue_script('feature-test');

	// Theme scripts (in footer)
	wp_register_script('pne-js', get_template_directory_uri() . '/js/pne.min.11172013.js', false, null, true);
