...
<div class="row">
	<br>
	<h1 class="textcenter">One Nation, Under Dog</h1>

	<div class="span8 offset2 textcenter">
		<p class="grande"><em>One Nation Under Dog</em> is a complicated and unwavering story that explores our relationship with dogs.</p>
		...
		<div class="tab-content">
			...
			<div class="tab-pane active" id="learn-more-btn">
				<p><a class="btn btn-large" data-toggle="tab" href="#learn-more">A Note from Our Founder</a></p>
			</div>
			...
			<div class="tab-pane fade" id="learn-more">
				...
				<div class="callout textleft">
					...
					<p class="textcenter"><a class="btn btn-large" data-toggle="tab" href="#learn-more-btn">Close</a></p>
				</div>
...
<div class="row">
	...
	<div class="span12 textcenter">
		...
		<p><iframe class="floatcenter" width="853" height="480" src="http://www.youtube.com/embed/qSMRfHwa5kE?rel=0" frameborder="0" allowfullscreen></iframe></p>
...
<div class="row textcenter">
	...
	<div class="span6">
		<h2 class="nospace"><a href="http://www.pawsnewengland.com/adopt/">Adopt</a></h2>
		<p>Give a deserving dog a loving home.</p>

		<h2 class="nospace"><a href="http://www.pawsnewengland.com/foster/">Foster</a></h2>
		<p>Help a dog transition from shelter to home.</p>

		<h2 class="nospace"><a href="http://www.pawsnewengland.com/donate/">Donate</a></h2>
		<p>Help fund our life-saving work.</p>
	</div>

	<div class="span6">
		<h2 class="nospace"><a href="http://www.spayusa.org/">Spay & Neuter</a></h2>
		<p>Help break the cycle of unwanted pets.</p>

		<h2 class="nospace"><a href="http://www.americanhumane.org/animals/stop-animal-abuse/advocacy/campaigns/stop-gassing-campaign.html">End Gas Chambers</a></h2>
		<p>Stop this barbaric and inhumane practice.</p>

		<h2 class="nospace"><a href="http://network.bestfriends.org/initiatives/puppymills/default.aspx">Shut-Down Puppy Mills</a></h2>
...
<div class="row textcenter">
	<div class="span12">
		...
		<p>
			<a class="btn-sm" id="twitter" rel="nofollow" href="http://twitter.com/?status=One%20Nation,%20Under%20Dog:%20Stories%20of%20Fear,%20Loss,%20and%20Betrayal%20<?php echo the_permalink(); ?>" onclick="centeredPopup(this.href,'myWindow', '550','450','yes');return false"><i class="icon twitter-alt"></i> Tweet</a>
			<a class="btn-sm" id="facebook" rel="nofollow" href="http://www.facebook.com/sharer.php?u=<?php echo the_permalink(); ?>&t=One%20Nation,%20Under%20Dog:%20Stories%20of%20Fear,%20Loss,%20and%20Betrayal" onclick="centeredPopup(this.href,'myWindow','675','450','yes');return false"><i class="icon facebook"></i> Like</a>
		</p>
...
<div class="modal hide" id="cherokee">
	<div class="modal-header">
		<a class="close" data-dismiss="modal">×</a>
		<h2>Cherokee</h2>
	</div>
...
<div class="modal hide" id="crystal">
	<div class="modal-header">
		<a class="close" data-dismiss="modal">×</a>
		<h2>Crystal</h2>
	</div>
