...
<div class="row">
	<h1 class="text-hero text-center">One Nation, Under Dog</h1>

	<div class="grid-4 offset-1">
		<p><span class="text-tall"><em>One Nation Under Dog</em> is a complicated and unwavering story that explores our relationship with dogs.</span></p>

		<p>PAWS New England had the honor of working closely with director Ellen Goosenberg Kent on this project. Our story is one of several showcased in this moving documentary.</p>
		...
		<div class='collapse' id='learn-more'>
			<div class="hero">
				...
				<p><img class="alignleft" src="<?php bloginfo('stylesheet_directory'); ?>/dist/img/hbo-kelly.jpg" height="260" width="200" title="A photo of Kelly Parker"></p>
...
<div class="row">
	<div class="grid-4 offset-1 text-center">
		<h1>The Trailer</h1>

		<p><iframe width="853" height="480" src="http://www.youtube.com/embed/qSMRfHwa5kE?rel=0" frameborder="0" allowfullscreen></iframe></p>

		<p><a class="btn" href="http://www.hbo.com/documentaries/one-nation-under-dog-stories-of-fear-loss-and-betrayal/index.html" target="_blank">Learn more at HBO.com</a></p>
	</div>
</div>
...
<div class="row">
	...
	<div class="grid-3">
		<p>On June 18th at 9pm, people all around the country will be coming together to watch this documentary.</p>

		<p>Have HBO? Host a screening party for your friends and family. Join the party online, and share your pics from the night on our Facebook page.</p>

		<p>
			<a class="btn" href="https://docs.google.com/spreadsheet/viewform?formkey=dG9JNHQ1WkoxMDd0X1ZkY0FkT2NGb2c6MQ#gid=0" target="_blank"><i class="icon-location"></i> Host a Party</a>
			<a class="btn" href="https://www.facebook.com/OneNationUnderDogVirtualScreeningParty" target="_blank"><i class="icon-facebook"></i> Join on Facebook</a>
			<a class="btn" href="http://www.pawsnewengland.com/downloads/Party_Package.pdf" target="_blank"><i class="icon-download"></i> Get the Party Kit</a>
		</p>
	</div>

	<div class="grid-3 hbo-form">
		<script src="https://docs.google.com/spreadsheet/gpub?url=http%3A%2F%2F9tm49u91btpu7le36r63p2sj07eqiv5p-ss-opensocial.googleusercontent.com%2Fgadgets%2Fifr%3Fup_title%3DScreening%2520Parties%26up_show_tooltip%3D0%26up_enable_wheel%3D0%26up_map_type%3Dnormal%26up__table_query_url%3Dhttps%253A%252F%252Fdocs.google.com%252Fspreadsheet%252Ftq%253Frange%253DG%25253AH%2526key%253D0AlWjqkH9oVKEdG9JNHQ1WkoxMDd0X1ZkY0FkT2NGb2c%2526gid%253D0%2526pub%253D1%26url%3Dhttp%253A%252F%252Fwww.google.com%252Fig%252Fmodules%252Fmap.xml%26spreadsheets%3Dspreadsheets&height=300&width=300"></script>
	</div>
...
<h1 class="text-center">Meet the Stars</h1>
...
<div class="row text-center">
	...
	<div class="grid-2">
		...
		<div class="modal text-left" data-modal-window id="julie"><div class="row"><div class="grid-4 offset-1">
			<h2>Julie Adams <a class="close modal-close" data-modal-close href="#">×</a></h2>
			...
			<h3>Julie's Life-Saving Work</h3>
	...
	<div class="grid-2">
		...
		<div class="modal text-left" data-modal-window id="john"><div class="row"><div class="grid-4 offset-1">
			...
			<h3>Working with the Tough Cases</h3>
	...
	<div class="grid-2">
		...
		<div class="modal text-left" data-modal-window id="cherokee"><div class="row"><div class="grid-4 offset-1">
...
<div class="row text-center">
	<div class="grid-2">
		...
		<div class="modal text-left" data-modal-window id="hope"><div class="row"><div class="grid-4 offset-1">
	...
	<div class="grid-2">
		...
		<div class="modal text-left" data-modal-window id="crystal"><div class="row"><div class="grid-4 offset-1">
...
<div class="row text-center">
	...
	<div class="grid-3">
		<h2 class="no-space"><a href="http://www.pawsnewengland.com/adopt/">Adopt</a></h2>
		<p>Give a deserving dog a loving home.</p>

		<h2 class="no-space"><a href="http://www.pawsnewengland.com/foster/">Foster</a></h2>
		<p>Help a dog transition from shelter to home.</p>

		<h2 class="no-space"><a href="http://www.pawsnewengland.com/donate/">Donate</a></h2>
	...
	<div class="grid-3">
		...
		<h2 class="no-space"><a href="http://network.bestfriends.org/initiatives/puppymills/default.aspx">Shut-Down Puppy Mills</a></h2>
...
<p class="text-center">
	<a class="btn btn-tweet" rel="nofollow" target="_blank" href="http://twitter.com/?status=One%20Nation,%20Under%20Dog:%20Stories%20of%20Fear,%20Loss,%20and%20Betrayal%20<?php echo the_permalink(); ?>">
		<i class="icon icon-twitter icon-inherit-color"></i> Tweet
	</a>
	<a class="btn btn-fb" rel="nofollow" target="_blank" href="http://www.facebook.com/sharer.php?u=<?php echo the_permalink(); ?>&t=One%20Nation,%20Under%20Dog:%20Stories%20of%20Fear,%20Loss,%20and%20Betrayal">
		<i class="icon icon-facebook icon-inherit-color"></i> Share
	</a>
</p>
